...
namespace MvcFeei.Controllers
{
    public class HomeController : Controller
    {
        private readonly MvcFeeiContext _context;

        public HomeController(MvcFeeiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(string id)
        {
            ...
            {
                return Problem("Entity set 'MvcFeeiContext.Alumno'  is null.");
            }
            var alumno = await _context.Alumno.FindAsync(id);
            if (alumno != null)
            {
